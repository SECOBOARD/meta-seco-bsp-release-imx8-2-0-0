...
patch -Np1 -r - sources/meta-fsl-bsp-release/imx/meta-bsp/recipes-bsp/imx-mkimage/imx-boot_0.2.bb < sources/meta-seco-bsp-release-imx8-2-0-0/patches/dtb-not-fetching.patch
# Patch meta-fsl layer adding dtbo support
patch -Np1 -r - sources/meta-fsl-bsp-release/imx/meta-bsp/classes/image_types_fsl.bbclass < sources/meta-seco-bsp-release-imx8-2-0-0/patches/0001-Yocto-i.MX8-DTBo-added-dtbo-support.patch
# Patch recipes to fix build failure
patch -Np1 -r - sources/meta-fsl-bsp-release/imx/meta-bsp/recipes-security/optee-imx/optee-os-imx_git.bb < sources/meta-seco-bsp-release-imx8-2-0-0/patches/0002-optee-os-imx-build-failure-fix-if-not-fetch-imx8mqevk.patch
...
echo "BBLAYERS += \" \${BSPDIR}/sources/meta-seco-bsp-release-imx8-2-0-0 \"" >> $BUILD_DIR/conf/bblayers.conf
