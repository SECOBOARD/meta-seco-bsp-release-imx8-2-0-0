...
PATH_MACHINE="sources/meta-seco-bsp-release-imx8-2-0-0/conf/machine/"
...
CLEAN="CLEAN"
COMPILER_PATH="/opt/fsl-imx-wayland/4.9.88-2.0.0/environment-setup-aarch64-poky-linux"
...
PATH_UBOOT_CONFIG_PATCH="sources/meta-seco-bsp-release-imx8-2-0-0/patches/dtb-not-fetching.patch"
UBOOT_BOARD_CONF="imx8mq_seco_c12_defconfig"
...
echo "" >> $PATH_MACHINE/$MACHINE_CONF_NAME
echo "MACHINE_FEATURES += \" pci wifi bluetooth optee\"" >> $PATH_MACHINE/$MACHINE_CONF_NAME
echo "" >> $PATH_MACHINE/$MACHINE_CONF_NAME
echo "MACHINE_SOCARCH_FILTER_append_mx8mq = \" virtual/libopenvg virtual/libgles1 virtual/libgles2 virtual/egl virtual/mesa virtual/libgl virtual/libg2d\"" >> $PATH_MACHINE/$MACHINE_CONF_NAME
echo "" >> $PATH_MACHINE/$MACHINE_CONF_NAME
...
echo "PREFERRED_VERSION_linux-seco = \"4.9.88\"" >> $PATH_MACHINE/$MACHINE_CONF_NAME
echo "" >> $PATH_MACHINE/$MACHINE_CONF_NAME
